...
class CreatePasswordState with _$CreatePasswordState {
  ...
  const factory CreatePasswordState.errorConfirmPassword(String message) =
      CreatePasswordStateErrorConfirmPassword;

  const factory CreatePasswordState.errorPassword(String message) =
      CreatePasswordStateErrorPassword;
  ...
  const factory CreatePasswordState.changePasswordSuccess() =
      CreatePasswordStateChangePasswrodSuccess;
}
