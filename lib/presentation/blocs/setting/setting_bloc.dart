...
class SettingBloc
  ...
  Future<void> getCurrentNetWork(GetCurrentNetWork event, Emitter<SettingState> emit) async {
  ...
  Future<void> switchNetWork(SwitchNetWork event, Emitter<SettingState> emit) async {
