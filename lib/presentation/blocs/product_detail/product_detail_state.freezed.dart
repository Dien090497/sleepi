...
class __$$ProductDetailInitialCopyWithImpl<$Res>
  ...
  __$$ProductDetailInitialCopyWithImpl(_$ProductDetailInitial _value,
      ...
      : super(_value, (v) => _then(v as _$ProductDetailInitial));

  @override
  _$ProductDetailInitial get _value => super._value as _$ProductDetailInitial;
}

/// @nodoc

class _$ProductDetailInitial
    with DiagnosticableTreeMixin
    implements ProductDetailInitial {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'ProductDetailState.initial'));
  }
...
class __$$ProductDetailLoadingCopyWithImpl<$Res>
  ...
  __$$ProductDetailLoadingCopyWithImpl(_$ProductDetailLoading _value,
      ...
      : super(_value, (v) => _then(v as _$ProductDetailLoading));

  @override
  _$ProductDetailLoading get _value => super._value as _$ProductDetailLoading;
}

/// @nodoc

class _$ProductDetailLoading
    with DiagnosticableTreeMixin
    implements ProductDetailLoading {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'ProductDetailState.loading'));
  }
...
class __$$ProductDetailLoadedCopyWithImpl<$Res>
  ...
  __$$ProductDetailLoadedCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$ProductDetailLoaded));

  @override
  _$ProductDetailLoaded get _value => super._value as _$ProductDetailLoaded;
}

/// @nodoc

class _$ProductDetailLoaded
    with DiagnosticableTreeMixin
    implements ProductDetailLoaded {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'ProductDetailState.loaded'));
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$ProductDetailLoaded);
  }
...
abstract class ProductDetailLoaded implements ProductDetailState {
  const factory ProductDetailLoaded() = _$ProductDetailLoaded;
}
...
class __$$ProductDetailErrorCopyWithImpl<$Res>
  ...
  __$$ProductDetailErrorCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$ProductDetailError));

  @override
  _$ProductDetailError get _value => super._value as _$ProductDetailError;
}

/// @nodoc

class _$ProductDetailError
    with DiagnosticableTreeMixin
    implements ProductDetailError {
  const _$ProductDetailError();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'ProductDetailState.error'));
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$ProductDetailError);
  }
...
abstract class ProductDetailError implements ProductDetailState {
  const factory ProductDetailError() = _$ProductDetailError;
}
