        ...
        if (state is ChartMonthLoaded) {
          ...
          return ChartTabBody(
            ...
            children: [
              ...
              ChartStatisticShare(maxValue: 100, data: state.dataChart.first,),
              ...
              const ChartTitle(
                  ...
                  padding: EdgeInsets.zero),
              const SizedBox(height: 12),
              ChartStatisticShare(maxValue: 100,data: state.dataChart[1],),
              const SizedBox(height: 40),
              const ChartTitle(
              ...
              const SizedBox(height: 12),
              ChartStatisticShare(maxValue: 300, data: state.dataChart[2],),
              const SizedBox(height: 40),
              const ChartTitle(
                  ...
                  padding: EdgeInsets.zero),
              const SizedBox(height: 12),
              ChartStatisticShare(maxValue: 300, data: state.dataChart[3],),
              const SizedBox(height: 40),
              const ChartTitle(
                  ...
                  padding: EdgeInsets.zero),
              const SizedBox(height: 12),
              ChartStatisticShare(maxValue: 300, data: state.dataChart[4],),
              const SizedBox(height: 40),
              const ChartTitle(
              ...
              ChartStatisticShare(maxValue: 300, data: state.dataChart[5],),
              ...
              const ChartTitle(
                  ...
                  padding: EdgeInsets.zero),
              const SizedBox(height: 12),
              ChartStatisticShare(maxValue: 300, data: state.dataChart[6],),
              const SizedBox(height: 40),
              const ChartTitle(
                  ...
                  padding: EdgeInsets.zero),
              const SizedBox(height: 12),
              ChartStatisticShare(maxValue: 300, data: state.dataChart[7],),
            ],
          );
        }
