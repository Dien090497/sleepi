...
import '../usecase/approve_usecase.dart' as _i64;
import '../usecase/change_password_usecase.dart' as _i33;
import '../usecase/check_activation_code_usecase.dart' as _i65;
import '../usecase/check_approve_usecase.dart' as _i66;
import '../usecase/create_pass_code_usecase.dart' as _i68;
import '../usecase/create_password_usecase.dart' as _i69;
import '../usecase/current_user_usecase.dart' as _i71;
import '../usecase/get_amount_out_min_usecase.dart' as _i73;
import '../usecase/get_balance_for_tokens_usecase.dart' as _i74;
import '../usecase/get_balance_token_usecase.dart' as _i75;
import '../usecase/get_current_network_usecase.dart' as _i77;
import '../usecase/get_list_nft_detail_usecase.dart' as _i78;
import '../usecase/get_market_place_usecase.dart' as _i25;
import '../usecase/get_nfts_balance_usecase.dart' as _i79;
import '../usecase/get_nfts_ids_usecase.dart' as _i80;
...
import '../usecase/send_nft_to_spending_usecase.dart' as _i51;
import '../usecase/send_otp_mail_usecase.dart' as _i52;
import '../usecase/send_to_external_usecase.dart' as _i53;
import '../usecase/send_token_to_external.dart' as _i54;
import '../usecase/set_nft_approval_for_all_usecase.dart' as _i55;
import '../usecase/setting_active_code_usecase.dart' as _i56;
import '../usecase/sign_up_usecase.dart' as _i57;
import '../usecase/swap_token_usecase.dart' as _i58;
import '../usecase/to_spending_usecase.dart' as _i59;
import '../usecase/transfer_nft_usecase.dart' as _i60;
import '../usecase/validate_mnemonic.dart' as _i61;
import '../usecase/validate_passcode_usecase.dart' as _i62;
import '../usecase/verify_otp_usecase.dart' as _i63;
import '../usecase/wallet/create_wallet_usecase.dart' as _i70;
import '../usecase/wallet/current_wallet_usecase.dart' as _i72;
import '../usecase/wallet/first_open_wallet_session_usecase.dart' as _i67;
import '../usecase/wallet/get_current_mnemonic_usecasse.dart' as _i76;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i51.SendNftToSpendingUseCase>(
      () => _i51.SendNftToSpendingUseCase(get<_i36.INFTRepository>()));
  gh.factory<_i52.SendOTPMailUseCase>(
      () => _i52.SendOTPMailUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i53.SendToExternalUseCase>(
      () => _i53.SendToExternalUseCase(get<_i40.ITransactionRepository>()));
  gh.factory<_i54.SendTokenToExternalUseCase>(() =>
      _i54.SendTokenToExternalUseCase(get<_i40.ITransactionRepository>()));
  gh.factory<_i55.SetNftApprovalForAllUseCase>(
      () => _i55.SetNftApprovalForAllUseCase(get<_i36.INFTRepository>()));
  gh.factory<_i56.SettingActiveCodeUseCase>(
      () => _i56.SettingActiveCodeUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i57.SignUpUseCase>(
      () => _i57.SignUpUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i58.SwapTokenUseCase>(
      () => _i58.SwapTokenUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i59.ToSpendingUseCase>(() => _i59.ToSpendingUseCase(
      get<_i38.ISpendingRepository>(), get<_i42.IWalletRepository>()));
  gh.factory<_i60.TransferNftUseCase>(
      () => _i60.TransferNftUseCase(get<_i36.INFTRepository>()));
  gh.factory<_i61.ValidateMnemonicUseCase>(
      () => _i61.ValidateMnemonicUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i62.ValidatePassCodeUseCase>(
      () => _i62.ValidatePassCodeUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i63.VerifyOTPUseCase>(
      () => _i63.VerifyOTPUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i64.ApproveUseCase>(() => _i64.ApproveUseCase(
      get<_i38.ISpendingRepository>(), get<_i42.IWalletRepository>()));
  gh.factory<_i65.CheckActivationCodeUseCase>(
      () => _i65.CheckActivationCodeUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i66.CheckApproveUseCase>(
      () => _i66.CheckApproveUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i67.CheckFirstOpenWallet>(
      () => _i67.CheckFirstOpenWallet(get<_i42.IWalletRepository>()));
  gh.factory<_i68.CreatePassCodeUseCase>(
      () => _i68.CreatePassCodeUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i69.CreatePasswordUseCase>(
      () => _i69.CreatePasswordUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i70.CreateWalletUseCase>(
      () => _i70.CreateWalletUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i71.CurrentUserUseCase>(
      () => _i71.CurrentUserUseCase(get<_i34.IAuthRepository>()));
  gh.factory<_i72.CurrentWalletUseCase>(
      () => _i72.CurrentWalletUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i73.GetAmountOutMinUseCase>(
      () => _i73.GetAmountOutMinUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i74.GetBalanceForTokensUseCase>(
      () => _i74.GetBalanceForTokensUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i75.GetBalanceTokenUseCase>(
      () => _i75.GetBalanceTokenUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i76.GetCurrentMnemonicUsecase>(
      () => _i76.GetCurrentMnemonicUsecase(get<_i42.IWalletRepository>()));
  gh.factory<_i77.GetCurrentNetworkUseCase>(
      () => _i77.GetCurrentNetworkUseCase(get<_i42.IWalletRepository>()));
  gh.factory<_i78.GetListNftDetailUseCase>(
      () => _i78.GetListNftDetailUseCase(get<_i36.INFTRepository>()));
  gh.factory<_i79.GetNFTsBalanceUseCase>(
      () => _i79.GetNFTsBalanceUseCase(get<_i36.INFTRepository>()));
  gh.factory<_i80.GetNFTsIDsUseCase>(
      () => _i80.GetNFTsIDsUseCase(get<_i36.INFTRepository>()));
  return get;
}
