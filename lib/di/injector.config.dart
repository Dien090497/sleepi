...
import '../usecase/check_activation_code_usecase.dart' as _i51;
import '../usecase/create_pass_code_usecase.dart' as _i53;
import '../usecase/create_password_usecase.dart' as _i54;
import '../usecase/current_user_usecase.dart' as _i56;
import '../usecase/get_amount_out_min_usecase.dart' as _i58;
import '../usecase/get_balance_for_tokens_usecase.dart' as _i59;
import '../usecase/get_balance_token_usecase.dart' as _i60;
import '../usecase/get_current_network_usecase.dart' as _i62;
import '../usecase/get_nfts_usecase.dart' as _i63;
...
import '../usecase/wallet/create_wallet_usecase.dart' as _i55;
import '../usecase/wallet/current_wallet_usecase.dart' as _i57;
import '../usecase/wallet/first_open_wallet_session_usecase.dart' as _i52;
import '../usecase/wallet/get_current_mnemonic_usecasse.dart' as _i61;
import '../usecase/wallet/import_wallet_usecase.dart' as _i35;
import 'register_module.dart' as _i64; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i50.ApproveUseCase>(() => _i50.ApproveUseCase(
      get<_i29.ISpendingRepository>(), get<_i33.IWalletRepository>()));
  gh.factory<_i51.CheckActivationCodeUseCase>(
      () => _i51.CheckActivationCodeUseCase(get<_i25.IAuthRepository>()));
  gh.factory<_i52.CheckFirstOpenWallet>(
      () => _i52.CheckFirstOpenWallet(get<_i33.IWalletRepository>()));
  gh.factory<_i53.CreatePassCodeUseCase>(
      () => _i53.CreatePassCodeUseCase(get<_i25.IAuthRepository>()));
  gh.factory<_i54.CreatePasswordUseCase>(
      () => _i54.CreatePasswordUseCase(get<_i25.IAuthRepository>()));
  gh.factory<_i55.CreateWalletUseCase>(
      () => _i55.CreateWalletUseCase(get<_i33.IWalletRepository>()));
  gh.factory<_i56.CurrentUserUseCase>(
      () => _i56.CurrentUserUseCase(get<_i25.IAuthRepository>()));
  gh.factory<_i57.CurrentWalletUseCase>(
      () => _i57.CurrentWalletUseCase(get<_i33.IWalletRepository>()));
  gh.factory<_i58.GetAmountOutMinUseCase>(
      () => _i58.GetAmountOutMinUseCase(get<_i33.IWalletRepository>()));
  gh.factory<_i59.GetBalanceForTokensUseCase>(
      () => _i59.GetBalanceForTokensUseCase(get<_i33.IWalletRepository>()));
  gh.factory<_i60.GetBalanceTokenUseCase>(
      () => _i60.GetBalanceTokenUseCase(get<_i33.IWalletRepository>()));
  gh.factory<_i61.GetCurrentMnemonicUsecase>(
      () => _i61.GetCurrentMnemonicUsecase(get<_i33.IWalletRepository>()));
  gh.factory<_i62.GetCurrentNetworkUseCase>(
      () => _i62.GetCurrentNetworkUseCase(get<_i33.IWalletRepository>()));
  gh.factory<_i63.GetNFTsUseCase>(
      () => _i63.GetNFTsUseCase(get<_i27.INFTRepository>()));
  return get;
}
