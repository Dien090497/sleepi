...
import '../usecase/fetch_balance_spending_usecase.dart' as _i91;
import '../usecase/fetch_bed_usecase.dart' as _i92;
import '../usecase/get_amount_out_min_usecase.dart' as _i93;
import '../usecase/get_balance_for_tokens_usecase.dart' as _i94;
import '../usecase/get_balance_token_usecase.dart' as _i95;
import '../usecase/get_current_network_usecase.dart' as _i97;
import '../usecase/get_global_config.dart' as _i98;
import '../usecase/get_history_transaction_usecase.dart' as _i99;
...
import '../usecase/get_user_usecase.dart' as _i100;
import '../usecase/has_wallet_usecase.dart' as _i101;
import '../usecase/is_first_open_app_usecase.dart' as _i56;
import '../usecase/is_nft_approve_for_all_usecase.dart' as _i32;
...
import '../usecase/wallet/get_current_mnemonic_usecasse.dart' as _i96;
import '../usecase/wallet/import_wallet_usecase.dart' as _i55;
import '../usecase/withdraw_history_usecase.dart' as _i75;
import 'register_module.dart' as _i102; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i20.HistoryDataSource>(
      () => _i20.HistoryDataSource(get<_i13.Isar>()));
  ...
  gh.factory<_i24.SharedPreferenceDataSource>(
      () => _i24.SharedPreferenceDataSource(get<_i17.SharedPreferences>()));
  ...
  gh.factory<_i32.IsNftApproveForAllUseCase>(
      () => _i32.IsNftApproveForAllUseCase(get<_i28.INFTRepository>()));
  gh.factory<_i33.RefreshTokenInterceptor>(() =>
      _i33.RefreshTokenInterceptor(get<_i23.SecureStorage>(), get<_i7.Dio>()));
  gh.factory<_i34.SendNftToSpendingUseCase>(() => _i34.SendNftToSpendingUseCase(
      get<_i28.INFTRepository>(), get<_i23.SecureStorage>()));
  gh.factory<_i35.SendToExternalUseCase>(
      () => _i35.SendToExternalUseCase(get<_i30.ITransactionRepository>()));
  gh.factory<_i36.SendTokenToExternalUseCase>(() =>
      _i36.SendTokenToExternalUseCase(get<_i30.ITransactionRepository>()));
  gh.factory<_i37.SetNftApprovalForAllUseCase>(
      () => _i37.SetNftApprovalForAllUseCase(get<_i28.INFTRepository>()));
  ...
  gh.factory<_i39.TransferNftUseCase>(
      () => _i39.TransferNftUseCase(get<_i28.INFTRepository>()));
  gh.factory<_i40.AuthDataSource>(() => _i40.AuthDataSource(get<_i7.Dio>(),
      get<_i27.AuthInterceptor>(), get<_i33.RefreshTokenInterceptor>()));
  gh.factory<_i41.EstimateNftFunctionFeeUseCase>(
      () => _i41.EstimateNftFunctionFeeUseCase(get<_i28.INFTRepository>()));
  gh.factory<_i42.GetListNftDetailUseCase>(
      () => _i42.GetListNftDetailUseCase(get<_i28.INFTRepository>()));
  gh.factory<_i43.GetNFTsBalanceUseCase>(
      () => _i43.GetNFTsBalanceUseCase(get<_i28.INFTRepository>()));
  gh.factory<_i44.GetNFTsIDsUseCase>(
      () => _i44.GetNFTsIDsUseCase(get<_i28.INFTRepository>()));
  ...
  gh.factory<_i49.ISpendingRepository>(() => _i50.SpendingImplementation(
      get<_i25.SpendingDataSource>(),
      get<_i26.Web3DataSource>(),
      get<_i40.AuthDataSource>()));
  gh.factory<_i51.IUserRepository>(() => _i52.UserImplementation(
      get<_i40.AuthDataSource>(), get<_i23.SecureStorage>()));
  ...
  gh.factory<_i56.IsFirstOpenAppUseCase>(
      () => _i56.IsFirstOpenAppUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i57.IsPassCodeCreatedUseCase>(
      () => _i57.IsPassCodeCreatedUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i58.LogInUseCase>(
      () => _i58.LogInUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i59.LogOutUseCase>(
      () => _i59.LogOutUseCase(get<_i45.IAuthRepository>()));
  ...
  gh.factory<_i64.SettingActiveCodeUseCase>(
      () => _i64.SettingActiveCodeUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i65.SignUpUseCase>(
      () => _i65.SignUpUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i66.StakingInfoUseCase>(
      () => _i66.StakingInfoUseCase(get<_i49.ISpendingRepository>()));
  gh.factory<_i67.StakingUseCase>(
      () => _i67.StakingUseCase(get<_i49.ISpendingRepository>()));
  gh.factory<_i68.SwapTokenUseCase>(
      () => _i68.SwapTokenUseCase(get<_i53.IWalletRepository>()));
  ...
  gh.factory<_i70.TransferTokenToMainWalletUseCase>(
      () => _i70.TransferTokenToMainWalletUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i71.UnStakingUseCase>(
      () => _i71.UnStakingUseCase(get<_i49.ISpendingRepository>()));
  gh.factory<_i72.ValidateMnemonicUseCase>(
      () => _i72.ValidateMnemonicUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i73.ValidatePassCodeUseCase>(
      () => _i73.ValidatePassCodeUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i74.VerifyOTPUseCase>(
      () => _i74.VerifyOTPUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i75.WithdrawHistoryUseCase>(
      () => _i75.WithdrawHistoryUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i76.ActivationCodeSettingUseCase>(
      () => _i76.ActivationCodeSettingUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i77.AddItemToBedUseCase>(
      () => _i77.AddItemToBedUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i78.ApproveUseCase>(() => _i78.ApproveUseCase(
      get<_i49.ISpendingRepository>(), get<_i53.IWalletRepository>()));
  gh.factory<_i79.BuyNFTUseCase>(
      () => _i79.BuyNFTUseCase(get<_i47.IMarketPlaceRepository>()));
  gh.factory<_i80.ChangePasswordUseCase>(
      () => _i80.ChangePasswordUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i81.CheckActivationCodeUseCase>(
      () => _i81.CheckActivationCodeUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i82.CheckApproveUseCase>(
      () => _i82.CheckApproveUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i83.CheckFirstOpenWallet>(
      () => _i83.CheckFirstOpenWallet(get<_i53.IWalletRepository>()));
  gh.factory<_i84.CompoundUseCase>(
      () => _i84.CompoundUseCase(get<_i49.ISpendingRepository>()));
  gh.factory<_i85.CreatePassCodeUseCase>(
      () => _i85.CreatePassCodeUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i86.CreatePasswordUseCase>(
      () => _i86.CreatePasswordUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i87.CreateWalletUseCase>(
      () => _i87.CreateWalletUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i88.CurrentUserUseCase>(
      () => _i88.CurrentUserUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i89.CurrentWalletUseCase>(
      () => _i89.CurrentWalletUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i90.EstimateGasWithdrawUseCase>(
      () => _i90.EstimateGasWithdrawUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i91.FetchBalanceSpendingUseCase>(
      () => _i91.FetchBalanceSpendingUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i92.FetchBedUseCase>(
      () => _i92.FetchBedUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i93.GetAmountOutMinUseCase>(
      () => _i93.GetAmountOutMinUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i94.GetBalanceForTokensUseCase>(
      () => _i94.GetBalanceForTokensUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i95.GetBalanceTokenUseCase>(
      () => _i95.GetBalanceTokenUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i96.GetCurrentMnemonicUsecase>(
      () => _i96.GetCurrentMnemonicUsecase(get<_i53.IWalletRepository>()));
  gh.factory<_i97.GetCurrentNetworkUseCase>(
      () => _i97.GetCurrentNetworkUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i98.GetGlobalConfigUseCase>(
      () => _i98.GetGlobalConfigUseCase(get<_i51.IUserRepository>()));
  gh.factory<_i99.GetHistoryTransactionUseCase>(
      () => _i99.GetHistoryTransactionUseCase(get<_i53.IWalletRepository>()));
  gh.factory<_i100.GetUserUseCase>(
      () => _i100.GetUserUseCase(get<_i45.IAuthRepository>()));
  gh.factory<_i101.HasWalletUseCase>(
      () => _i101.HasWalletUseCase(get<_i53.IWalletRepository>()));
  return get;
}
