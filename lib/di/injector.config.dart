...
import '../datasources/local/shared_preference_datasource.dart' as _i8;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.factoryAsync<_i7.SharedPreferences>(() => registerModule.sharedPref,
      preResolve: true);
  gh.factory<_i8.SharedPreferenceDataSource>(
      () => _i8.SharedPreferenceDataSource(get<_i7.SharedPreferences>()));
  return get;
}
