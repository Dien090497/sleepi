...
import '../repository/implementations/network_connection_implementation.dart'
    as _i23;
import '../repository/implementations/nft_implementation.dart' as _i108;
...
import '../repository/nft_repository.dart' as _i107;
...
import '../usecase/activation_code_setting_usecase.dart' as _i77;
import '../usecase/add_item_to_bed_usecase.dart' as _i78;
import '../usecase/approve_usecase.dart' as _i79;
import '../usecase/buy_nft_usecase.dart' as _i80;
import '../usecase/change_password_usecase.dart' as _i81;
import '../usecase/check_activation_code_usecase.dart' as _i82;
import '../usecase/check_approve_usecase.dart' as _i83;
import '../usecase/compound_usecase.dart' as _i85;
import '../usecase/create_pass_code_usecase.dart' as _i86;
import '../usecase/create_password_usecase.dart' as _i87;
import '../usecase/current_user_usecase.dart' as _i89;
import '../usecase/estimate_gas_withdraw.dart' as _i91;
import '../usecase/estimate_nft_function_fee_usecase.dart' as _i113;
import '../usecase/estimate_sleep_tracking_usecase.dart' as _i92;
import '../usecase/estimate_tracking_usecase.dart' as _i93;
import '../usecase/fetch_balance_spending_usecase.dart' as _i94;
import '../usecase/fetch_bed_usecase.dart' as _i95;
import '../usecase/fetch_item_owner_usecase.dart' as _i96;
import '../usecase/fetch_lucky_box_usecase.dart' as _i97;
import '../usecase/get_amount_out_min_usecase.dart' as _i98;
import '../usecase/get_balance_for_tokens_usecase.dart' as _i99;
import '../usecase/get_balance_token_usecase.dart' as _i100;
import '../usecase/get_current_network_usecase.dart' as _i102;
import '../usecase/get_global_config.dart' as _i103;
import '../usecase/get_history_transaction_usecase.dart' as _i104;
import '../usecase/get_list_nft_detail_usecase.dart' as _i114;
import '../usecase/get_market_place_usecase.dart' as _i59;
import '../usecase/get_network_connection_usecase.dart' as _i32;
import '../usecase/get_nfts_balance_usecase.dart' as _i115;
import '../usecase/get_nfts_ids_usecase.dart' as _i116;
import '../usecase/get_user_usecase.dart' as _i105;
import '../usecase/has_wallet_usecase.dart' as _i106;
import '../usecase/is_first_open_app_usecase.dart' as _i54;
import '../usecase/is_nft_approve_for_all_usecase.dart' as _i109;
...
import '../usecase/send_nft_to_spending_usecase.dart' as _i110;
...
import '../usecase/set_nft_approval_for_all_usecase.dart' as _i111;
...
import '../usecase/staking_info_usecase.dart' as _i67;
import '../usecase/staking_usecase.dart' as _i68;
import '../usecase/swap_token_usecase.dart' as _i69;
import '../usecase/to_spending_usecase.dart' as _i70;
import '../usecase/transfer_nft_usecase.dart' as _i112;
import '../usecase/transfer_token_to_main_wallet_usecase.dart' as _i71;
import '../usecase/unstaking_usecase.dart' as _i72;
import '../usecase/validate_mnemonic.dart' as _i73;
import '../usecase/validate_passcode_usecase.dart' as _i74;
import '../usecase/verify_otp_usecase.dart' as _i75;
import '../usecase/wallet/create_wallet_usecase.dart' as _i88;
import '../usecase/wallet/current_wallet_usecase.dart' as _i90;
import '../usecase/wallet/first_open_wallet_session_usecase.dart' as _i84;
import '../usecase/wallet/get_current_mnemonic_usecasse.dart' as _i101;
import '../usecase/wallet/import_wallet_usecase.dart' as _i53;
import '../usecase/withdraw_history_usecase.dart' as _i76;
import 'register_module.dart' as _i117; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i62.RemoveItemFromBedUseCase>(
      () => _i62.RemoveItemFromBedUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i63.SendOTPMailUseCase>(
      () => _i63.SendOTPMailUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i64.SettingActiveCodeUseCase>(
      () => _i64.SettingActiveCodeUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i65.SignUpUseCase>(
      () => _i65.SignUpUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i66.SpeedUpLuckyBoxUseCase>(
      () => _i66.SpeedUpLuckyBoxUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i67.StakingInfoUseCase>(
      () => _i67.StakingInfoUseCase(get<_i47.ISpendingRepository>()));
  gh.factory<_i68.StakingUseCase>(
      () => _i68.StakingUseCase(get<_i47.ISpendingRepository>()));
  gh.factory<_i69.SwapTokenUseCase>(
      () => _i69.SwapTokenUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i70.ToSpendingUseCase>(() => _i70.ToSpendingUseCase(
      get<_i47.ISpendingRepository>(), get<_i51.IWalletRepository>()));
  gh.factory<_i71.TransferTokenToMainWalletUseCase>(
      () => _i71.TransferTokenToMainWalletUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i72.UnStakingUseCase>(
      () => _i72.UnStakingUseCase(get<_i47.ISpendingRepository>()));
  gh.factory<_i73.ValidateMnemonicUseCase>(
      () => _i73.ValidateMnemonicUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i74.ValidatePassCodeUseCase>(
      () => _i74.ValidatePassCodeUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i75.VerifyOTPUseCase>(
      () => _i75.VerifyOTPUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i76.WithdrawHistoryUseCase>(
      () => _i76.WithdrawHistoryUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i77.ActivationCodeSettingUseCase>(
      () => _i77.ActivationCodeSettingUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i78.AddItemToBedUseCase>(
      () => _i78.AddItemToBedUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i79.ApproveUseCase>(() => _i79.ApproveUseCase(
      get<_i47.ISpendingRepository>(), get<_i51.IWalletRepository>()));
  gh.factory<_i80.BuyNFTUseCase>(
      () => _i80.BuyNFTUseCase(get<_i43.IMarketPlaceRepository>()));
  gh.factory<_i81.ChangePasswordUseCase>(
      () => _i81.ChangePasswordUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i82.CheckActivationCodeUseCase>(
      () => _i82.CheckActivationCodeUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i83.CheckApproveUseCase>(
      () => _i83.CheckApproveUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i84.CheckFirstOpenWallet>(
      () => _i84.CheckFirstOpenWallet(get<_i51.IWalletRepository>()));
  gh.factory<_i85.CompoundUseCase>(
      () => _i85.CompoundUseCase(get<_i47.ISpendingRepository>()));
  gh.factory<_i86.CreatePassCodeUseCase>(
      () => _i86.CreatePassCodeUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i87.CreatePasswordUseCase>(
      () => _i87.CreatePasswordUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i88.CreateWalletUseCase>(
      () => _i88.CreateWalletUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i89.CurrentUserUseCase>(
      () => _i89.CurrentUserUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i90.CurrentWalletUseCase>(
      () => _i90.CurrentWalletUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i91.EstimateGasWithdrawUseCase>(
      () => _i91.EstimateGasWithdrawUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i92.EstimateSleepTrackingUseCase>(() =>
      _i92.EstimateSleepTrackingUseCase(get<_i45.ISleepTrackingRepository>()));
  gh.factory<_i93.EstimateTrackingUseCase>(
      () => _i93.EstimateTrackingUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i94.FetchBalanceSpendingUseCase>(
      () => _i94.FetchBalanceSpendingUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i95.FetchBedUseCase>(
      () => _i95.FetchBedUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i96.FetchItemOwnerUseCase>(
      () => _i96.FetchItemOwnerUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i97.FetchLuckyBoxUseCase>(
      () => _i97.FetchLuckyBoxUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i98.GetAmountOutMinUseCase>(
      () => _i98.GetAmountOutMinUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i99.GetBalanceForTokensUseCase>(
      () => _i99.GetBalanceForTokensUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i100.GetBalanceTokenUseCase>(
      () => _i100.GetBalanceTokenUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i101.GetCurrentMnemonicUsecase>(
      () => _i101.GetCurrentMnemonicUsecase(get<_i51.IWalletRepository>()));
  gh.factory<_i102.GetCurrentNetworkUseCase>(
      () => _i102.GetCurrentNetworkUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i103.GetGlobalConfigUseCase>(
      () => _i103.GetGlobalConfigUseCase(get<_i49.IUserRepository>()));
  gh.factory<_i104.GetHistoryTransactionUseCase>(
      () => _i104.GetHistoryTransactionUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i105.GetUserUseCase>(
      () => _i105.GetUserUseCase(get<_i41.IAuthRepository>()));
  gh.factory<_i106.HasWalletUseCase>(
      () => _i106.HasWalletUseCase(get<_i51.IWalletRepository>()));
  gh.factory<_i107.INFTRepository>(() => _i108.NFTImplementation(
      get<_i24.NFTDataSource>(),
      get<_i60.NftApi>(),
      get<_i27.SecureStorage>()));
  gh.factory<_i109.IsNftApproveForAllUseCase>(
      () => _i109.IsNftApproveForAllUseCase(get<_i107.INFTRepository>()));
  gh.factory<_i110.SendNftToSpendingUseCase>(() =>
      _i110.SendNftToSpendingUseCase(
          get<_i107.INFTRepository>(), get<_i27.SecureStorage>()));
  gh.factory<_i111.SetNftApprovalForAllUseCase>(
      () => _i111.SetNftApprovalForAllUseCase(get<_i107.INFTRepository>()));
  gh.factory<_i112.TransferNftUseCase>(
      () => _i112.TransferNftUseCase(get<_i107.INFTRepository>()));
  gh.factory<_i113.EstimateNftFunctionFeeUseCase>(
      () => _i113.EstimateNftFunctionFeeUseCase(get<_i107.INFTRepository>()));
  gh.factory<_i114.GetListNftDetailUseCase>(
      () => _i114.GetListNftDetailUseCase(get<_i107.INFTRepository>()));
  gh.factory<_i115.GetNFTsBalanceUseCase>(
      () => _i115.GetNFTsBalanceUseCase(get<_i107.INFTRepository>()));
  gh.factory<_i116.GetNFTsIDsUseCase>(
      () => _i116.GetNFTsIDsUseCase(get<_i107.INFTRepository>()));
  return get;
}
