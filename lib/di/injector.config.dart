...
import '../datasources/local/secure_storage.dart' as _i16;
import '../datasources/local/shared_preference_datasource.dart' as _i18;
import '../datasources/remote/network/web3_datasource.dart' as _i15;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i15.Web3DataSource>(_i15.Web3DataSource(get<_i3.Client>()));
  gh.factory<_i16.SecureStorage>(() => _i16.SecureStorage(
      get<_i17.FlutterSecureStorage>(), get<_i14.SharedPreferences>()));
  gh.factory<_i18.SharedPreferenceDataSource>(
      () => _i18.SharedPreferenceDataSource(get<_i14.SharedPreferences>()));
  return get;
}

class _$RPCModule extends _i15.RPCModule {}
