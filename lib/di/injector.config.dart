...
import '../repository/auth_repository.dart' as _i57;
import '../repository/implementations/auth_implementation.dart' as _i58;
import '../repository/implementations/market_place_implementation.dart' as _i60;
...
import '../repository/implementations/user_implementations.dart' as _i62;
import '../repository/implementations/wallet_implementation.dart' as _i33;
import '../repository/market_place_repository.dart' as _i59;
...
import '../repository/user_repository.dart' as _i61;
import '../repository/wallet_repository.dart' as _i32;
import '../usecase/activation_code_setting_usecase.dart' as _i74;
import '../usecase/approve_usecase.dart' as _i43;
import '../usecase/change_password_usecase.dart' as _i75;
import '../usecase/check_activation_code_usecase.dart' as _i76;
import '../usecase/check_approve_usecase.dart' as _i45;
...
import '../usecase/get_amount_out_min_usecase.dart' as _i49;
import '../usecase/get_balance_for_tokens_usecase.dart' as _i50;
import '../usecase/get_balance_token_usecase.dart' as _i51;
import '../usecase/get_current_network_usecase.dart' as _i53;
import '../usecase/get_list_nft_detail_usecase.dart' as _i54;
import '../usecase/get_market_place_usecase.dart' as _i68;
import '../usecase/get_nfts_balance_usecase.dart' as _i55;
import '../usecase/get_nfts_ids_usecase.dart' as _i56;
...
import '../usecase/swap_token_usecase.dart' as _i39;
import '../usecase/to_spending_usecase.dart' as _i40;
import '../usecase/transfer_nft_usecase.dart' as _i41;
import '../usecase/validate_mnemonic.dart' as _i42;
import '../usecase/validate_passcode_usecase.dart' as _i72;
import '../usecase/verify_otp_usecase.dart' as _i73;
import '../usecase/wallet/create_wallet_usecase.dart' as _i47;
import '../usecase/wallet/current_wallet_usecase.dart' as _i48;
import '../usecase/wallet/first_open_wallet_session_usecase.dart' as _i46;
import '../usecase/wallet/get_current_mnemonic_usecasse.dart' as _i52;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i36.SendToExternalUseCase>(
      () => _i36.SendToExternalUseCase(get<_i30.ITransactionRepository>()));
  gh.factory<_i37.SendTokenToExternalUseCase>(() =>
      _i37.SendTokenToExternalUseCase(get<_i30.ITransactionRepository>()));
  gh.factory<_i38.SetNftApprovalForAllUseCase>(
      () => _i38.SetNftApprovalForAllUseCase(get<_i26.INFTRepository>()));
  gh.factory<_i39.SwapTokenUseCase>(
      () => _i39.SwapTokenUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i40.ToSpendingUseCase>(() => _i40.ToSpendingUseCase(
      get<_i28.ISpendingRepository>(), get<_i32.IWalletRepository>()));
  gh.factory<_i41.TransferNftUseCase>(
      () => _i41.TransferNftUseCase(get<_i26.INFTRepository>()));
  gh.factory<_i42.ValidateMnemonicUseCase>(
      () => _i42.ValidateMnemonicUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i43.ApproveUseCase>(() => _i43.ApproveUseCase(
      get<_i28.ISpendingRepository>(), get<_i32.IWalletRepository>()));
  gh.factory<_i44.AuthDataSource>(
      () => _i44.AuthDataSource(get<_i7.Dio>(), get<_i25.AuthInterceptor>()));
  gh.factory<_i45.CheckApproveUseCase>(
      () => _i45.CheckApproveUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i46.CheckFirstOpenWallet>(
      () => _i46.CheckFirstOpenWallet(get<_i32.IWalletRepository>()));
  gh.factory<_i47.CreateWalletUseCase>(
      () => _i47.CreateWalletUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i48.CurrentWalletUseCase>(
      () => _i48.CurrentWalletUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i49.GetAmountOutMinUseCase>(
      () => _i49.GetAmountOutMinUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i50.GetBalanceForTokensUseCase>(
      () => _i50.GetBalanceForTokensUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i51.GetBalanceTokenUseCase>(
      () => _i51.GetBalanceTokenUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i52.GetCurrentMnemonicUsecase>(
      () => _i52.GetCurrentMnemonicUsecase(get<_i32.IWalletRepository>()));
  gh.factory<_i53.GetCurrentNetworkUseCase>(
      () => _i53.GetCurrentNetworkUseCase(get<_i32.IWalletRepository>()));
  gh.factory<_i54.GetListNftDetailUseCase>(
      () => _i54.GetListNftDetailUseCase(get<_i26.INFTRepository>()));
  gh.factory<_i55.GetNFTsBalanceUseCase>(
      () => _i55.GetNFTsBalanceUseCase(get<_i26.INFTRepository>()));
  gh.factory<_i56.GetNFTsIDsUseCase>(
      () => _i56.GetNFTsIDsUseCase(get<_i26.INFTRepository>()));
  gh.factory<_i57.IAuthRepository>(() => _i58.AuthImplementation(
      get<_i21.SecureStorage>(),
      get<_i44.AuthDataSource>(),
      get<_i13.IsarDataSource>(),
      get<_i11.GetStorageDataSource>()));
  gh.factory<_i59.IMarketPlaceRepository>(
      () => _i60.TransactionImplementation(get<_i44.AuthDataSource>()));
  gh.factory<_i61.IUserRepository>(
      () => _i62.UserImplementation(get<_i44.AuthDataSource>()));
  gh.factory<_i63.IsFirstOpenAppUseCase>(
      () => _i63.IsFirstOpenAppUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i64.IsPassCodeCreatedUseCase>(
      () => _i64.IsPassCodeCreatedUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i65.LogInUseCase>(
      () => _i65.LogInUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i66.LogOutUseCase>(
      () => _i66.LogOutUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i67.MakeFirstOpenAppUseCase>(
      () => _i67.MakeFirstOpenAppUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i68.MarketPlaceUseCase>(
      () => _i68.MarketPlaceUseCase(get<_i59.IMarketPlaceRepository>()));
  gh.factory<_i69.SendOTPMailUseCase>(
      () => _i69.SendOTPMailUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i70.SettingActiveCodeUseCase>(
      () => _i70.SettingActiveCodeUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i71.SignUpUseCase>(
      () => _i71.SignUpUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i72.ValidatePassCodeUseCase>(
      () => _i72.ValidatePassCodeUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i73.VerifyOTPUseCase>(
      () => _i73.VerifyOTPUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i74.ActivationCodeSettingUseCase>(
      () => _i74.ActivationCodeSettingUseCase(get<_i61.IUserRepository>()));
  gh.factory<_i75.ChangePasswordUseCase>(
      () => _i75.ChangePasswordUseCase(get<_i61.IUserRepository>()));
  gh.factory<_i76.CheckActivationCodeUseCase>(
      () => _i76.CheckActivationCodeUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i77.CreatePassCodeUseCase>(
      () => _i77.CreatePassCodeUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i78.CreatePasswordUseCase>(
      () => _i78.CreatePasswordUseCase(get<_i57.IAuthRepository>()));
  gh.factory<_i79.CurrentUserUseCase>(
      () => _i79.CurrentUserUseCase(get<_i57.IAuthRepository>()));
  return get;
}
