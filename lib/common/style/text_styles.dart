...
class TextStyles {
  ...
  static const lightGrey12 = TextStyle(fontSize: 12, color: AppColors.lightGrey);
  ...
  static const white12Underline = TextStyle(fontSize: 12, color: AppColors.white,   decoration: TextDecoration.underline,);
  ...
  static const bold18White = TextStyle(fontSize: 18, color: AppColors.white, fontWeight: FontWeight.w700);
  ...
  static const bold16LightWhite = TextStyle(fontSize: 16, color: AppColors.lightWhite, fontWeight: FontWeight.w700);

  static const bold12Blue = TextStyle(fontSize: 12, color: AppColors.blue, fontWeight: FontWeight.w700);
  ...
  static const bold14Yellow = TextStyle(fontSize: 14, color: AppColors.yellow, fontWeight: FontWeight.w700);
