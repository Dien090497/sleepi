...
class Nft extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<List<BigInt>> getTokensOfOwner(
      _i1.EthereumAddress _owner, BigInt _count, BigInt _start,
      {_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[10];
    assert(checkSignature(function, '89edc438'));
    final params = [_owner, _count, _start];
    final response = await read(function, params, atBlock);
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> mintTo(_i1.EthereumAddress to, String _tokenURI,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[14];
    assert(checkSignature(function, '0075a317'));
    final params = [to, _tokenURI];
    return write(credentials, transaction, function, params);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> tokenByIndex(BigInt index, {_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> tokenOfOwnerByIndex(_i1.EthereumAddress owner, BigInt index,
      {_i1.BlockNum? atBlock}) async {
