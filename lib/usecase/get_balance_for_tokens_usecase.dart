...
class GetBalanceForTokensUseCase
    extends UseCase<List<double>, ParamsBalanceOfToken> {
...
class ParamsBalanceOfToken {
  ...
  ParamsBalanceOfToken(
      {required this.walletInfoEntity, required this.addressContract});
}
